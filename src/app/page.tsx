...
import BarCrawlControls from "@/components/BarCrawlControls";
import { useBarCrawl } from "@/hooks/useBarCrawl";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Temporary Controls - Will be replaced by API updates */}
        <div className="mt-6 bg-blue-50/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-blue-200/50">
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-blue-700">
              Estes controles serão substituídos por atualizações em tempo real
              da API
            </p>
          </div>
          <BarCrawlControls
